  ...
  data: new SlashCommandBuilder()
      ...
      command
        ...
        .addUserOption((option) =>
          option
            .setName("user")
            .setDescription(
              "Specified user will be given specified amount of XP."
            )
            .setRequired(true)
        )
    ...
    .addSubcommand((command) =>
      command
        ...
        .setDescription("Set up an XP multiplier for a specifiied role.")
        ...
        .addStringOption((option) =>
          option
            ...
            .setRequired(true)
            .setDescription(
              "Specified amount of multiplier will be applied to specified role."
            )
        )
    )
    .addSubcommand((command) =>
    ...
    .addSubcommand((command) =>
      command.setName("enable").setDescription("Enables your leveling system.")
    )
    .addSubcommand((command) =>
      command

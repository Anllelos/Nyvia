...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            return interaction.reply({ content: `Kicked all members except those with the role: ${roleToExclude.name}.`, ephemeral: true });
        } catch (error) {
            console.error(error);
            return interaction.reply({ content: "An error occurred while trying to kick members.", ephemeral: true });
        }
    },
};